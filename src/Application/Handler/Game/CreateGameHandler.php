...
class CreateGameHandler
{
    ...
    public function handle(array $game): void
    {
        ...
        if (!$homeTeam) {
            throw new RuntimeException($game['awayTeam']." is not the part of our database");
        }
        ...
        if (!$league) {
            throw new RuntimeException($game['leagueApiId']." League is not the part of our database");
        }
